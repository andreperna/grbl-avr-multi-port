...
*/
...
#ifdef CPU_MAP_1284P_MELZI_BOARD // (Sanguino 1284P) Creality Melzi v1.1.4 Board
  #include "nuts_bolts.h"
  ...
  // #define SPINDLE_ENABLE_BIT      4 // MEGA2560 Digital Pin 4 - Ramps 1.4 Servo 4 Signal pin
  ...
  // #define COOLANT_MIST_BIT    5 // MEGA2560 Digital Pin 9 - Ramps 1.4 12v output
